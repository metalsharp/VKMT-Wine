...
EVIDENCE_DIR="${VKMT_P6_RELEASE_EVIDENCE_DIR:-$ROOT/docs/validation/roadmap-p6-release-$(date -u +%Y%m%dT%H%M%SZ)}"
...
RUN_ROOT="$RUNTIME_ROOT/build/roadmap-p6-release.$$.${RANDOM}"
